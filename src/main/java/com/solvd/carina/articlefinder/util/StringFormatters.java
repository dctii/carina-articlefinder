...
public class StringFormatters {
    ...
    public static String nestInChars(String boundaryMarker, String stringToWrap) {
        return nestInChars(boundaryMarker, stringToWrap, boundaryMarker);
    }

    public static String nestInBackticks(String stringToWrap) {
        return nestInChars(StringConstants.BACKTICK, stringToWrap);
    }
